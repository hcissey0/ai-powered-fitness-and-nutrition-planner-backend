...
SECRET_KEY = getenv('SECRET_KEY', 'django-insecure-secret-key')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest.authentication.CustomTokenAuthentication',  # Custom Token Authentication
...
def safe_get_current_site(request):
    try:
